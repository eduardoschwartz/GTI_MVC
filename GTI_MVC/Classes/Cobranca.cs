...
namespace GTI_Mvc.Classes {
    ...
    //        Token _token = (Token)JsonConvert.DeserializeObject<Token>(responseContent);
    //    }
    //}
    ...
    //    webClient.Headers.Add("Authorization", "Basic ");
    //   // webClient.BaseAddress = "https://oauth.hm.bb.com.br/";
    //    var json = webClient.DownloadString("https://oauth.hm.bb.com.br/oauth/token?gw-dev-app-key=d27b67790cffab50136be17db0050c56b9d1a5b1");
    //    Token _token = (Token)JsonConvert.DeserializeObject<Token>(json);
    //}
    ...
    //dynamic responseContent = JsonConvert.DeserializeObject(responseContent);
    //string _token = "";
